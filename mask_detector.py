...
arg.add_argument("-f", "--face", type=str,default="detector",help="path to face detector model directory")
...
# load our serialized face detector model from disk to use 
...
# load the input image from disk, clone it, and grab the image spatialdimensions
...
# show the output image after detection  
